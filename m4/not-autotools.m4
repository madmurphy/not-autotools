...
dnl  **************************************************************************
dnl
dnl  Short version of `NC_REQ_PROGS()` with autogenerated descriptions
dnl
dnl  With this short version the description string is always set to "path to
dnl  `progN` utility".
dnl
dnl  This macro may be invoked only after having invoked `AC_INIT()`.
dnl
...
dnl  **************************************************************************
dnl
dnl  Short version of `NM_QUERY_PROGS()` with autogenerated descriptions
dnl
dnl  With this short version the description string is always set to "path to
dnl  `progN` utility".
dnl
